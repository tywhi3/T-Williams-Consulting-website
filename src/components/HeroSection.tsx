        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="w-full md:w-1/2 text-center md:text-left mb-12 md:mb-0">
            <h1 className="font-cormorant text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
              Navigating Your <br className="hidden md:block" />
              Journey to Success
            </h1>
            <p className="font-montserrat text-brand-soft-gray mb-8 max-w-md mx-auto md:mx-0">
              Expert guidance for wedding planning and business consulting. We provide tailored solutions to turn your vision into reality.
            </p>
